        ...
        <div className="w-full max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-2xl shadow-gray-200/50 border border-gray-100 mt-8 mb-20">
            <header className="flex justify-between items-center mb-8">
                ...
                <button
                    ...
                    className="px-6 py-2.5 rounded-full bg-indigo-500 text-white font-semibold hover:bg-indigo-600 transition-colors shadow-lg shadow-indigo-200 flex items-center gap-2"
                >
                    <svg
